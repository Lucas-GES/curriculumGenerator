<div class="m-4">
    <form name="curriculums" id="curriculums" action="{{ route('curriculums.update', $curriculum) }}" method="POST">
        @method('PUT')
        @csrf
        ...
        <div :class="{ 'hidden': !principaisInformacoes }">
            ...
            <div class="mt-4">
                ...
                <input type="text" id="estadoCivil" name="estadoCivil" class="form-control w-full rounded"
                    required="" value="{{ $curriculum->estadoCivil }}">
            </div>
            <div class="mt-4">
            ...
            <div class="mt-4">
                ...
                <input type="text" id="telefone" name="telefone" class="form-control w-full rounded" required=""
                    value="{{ $curriculum->telefone }}">
            </div>
            <div class="mt-4">
                <label for="perfil">Breve descrição do seu perfil:</label>
                <textarea id="perfil" name="perfil" class="form-control w-full rounded" required="">{{ $curriculum->perfil }}</textarea>
            </div>
        </div>
        ...
        <div class="text-center mt-6">
            <button class="bg-blue-500 w-full h-12 rounded text-white font-bold" type="button"
                @click="formacao = !formacao">Formação
                Acadêmica</button>
        </div>
        <div :class="{ 'hidden': !formacao }">
            @foreach ($formacao as $index => $form)
                <tr>
                    <td>
                        <div>
                            <input type="hidden" id="formacaoId[{{ $index }}]"
                                name="formacaoId[{{ $index }}]"
                                wire:model.prevent="formacao.{{ $index }}.formacaoId">
                        </div>
                    </td>
                    <td>
                        <div>
                            ...
                            <input type="text" id="formacaoNome[{{ $index }}]"
                                ...
                                wire:model.prevent="formacao.{{ $index }}.formacaoNome" required="">
                        </div>
                    </td>
                    <td>
                        <div>
                            ...
                            <textarea type="text" id="formacaoDescricao[{{ $index }}]" name="formacaoDescricao[{{ $index }}]"
                                ...
                                wire:model.prevent="formacao.{{ $index }}.formacaoDescricao"></textarea>
                        </div>
                    </td>
                    <td>
                        <div class="text-end">
                            <button class="bg-red-500 w-44 h-8 rounded mt-4 text-white font-bold hover:bg-green-600"
                                wire:click.prevent="removeFormacao({{ $index }})">Remover Formação
                                {{ $index + 1 }}</button>
                        </div>
                    </td>
                </tr>
        ...
        <div class="text-center mt-6">
            <button class="bg-blue-500 w-full h-12 rounded text-white font-bold" type="button"
                @click="formacaoComplementar = !formacaoComplementar">Formação
                Complementar</button>
        </div>
        <div :class="{ 'hidden': !formacaoComplementar }">
            ...
            @foreach ($formacaoComplementar as $index => $form)
                <tr>
                    <td>
                        <div>
                            <input type="hidden" id="formacaoComplementarId[{{ $index }}]"
                                name="formacaoComplementarId[{{ $index }}]"
                                wire:model.prevent="formacaoComplementar.{{ $index }}.formacaoComplementarId">
                        </div>
                    </td>
                    <td>
                        <div>
                            ...
                            <input type="text" id="formacaoComplementarNome[{{ $index }}]"
                                name="formacaoComplementarNome[{{ $index }}]"
                                class="form-control w-full rounded"
                    ...
                    <td>
                        <div>
                            <label for="formacaoComplementarDescricao">Descrição da formação
                                complementar{{ $index + 1 }}:</label>
                            <textarea type="text" id="formacaoComplementarDescricao[{{ $index }}]"
                                name="formacaoComplementarDescricao[{{ $index }}]" class="form-control w-full rounded" required=""
                                wire:model.prevent="formacaoComplementar.{{ $index }}.formacaoComplementarDescricao"></textarea>
                        </div>
                    </td>
                    <td>
                        <div>
                            <label for="formacaoComplementarHoras">Horas realizadas da formação
                                {{ $index + 1 }}:</label>
                            <input type="number" id="formacaoComplementarHoras[{{ $index }}]"
                                name="formacaoComplementarHoras[{{ $index }}]"
                                class="form-control w-full rounded" required=""
                    ...
                    <td>
                        <div class="text-end">
                            <button class="bg-red-500 w-44 h-12 rounded mt-4 text-white font-bold hover:bg-green-600"
                                wire:click.prevent="removeFormacaoComplentar({{ $index }})">Remover Formação
                                Complementar {{ $index + 1 }}</button>
                        </div>
                    </td>
                </tr>
            @endforeach
        ...
        <div class="text-center mt-6">
            <button class="bg-blue-500 w-full h-12 rounded text-white font-bold" type="button"
                @click="experiencia = !experiencia">Experiência</button>
        </div>
        <div :class="{ 'hidden': !experiencia }">
            ...
            @foreach ($experiencia as $index => $form)
                <tr>
                    <td>
                        <div>
                            <input type="hidden" id="experienciaId[{{ $index }}]"
                                name="experienciaId[{{ $index }}]"
                                wire:model.prevent="experiencia.{{ $index }}.experienciaId">
                        </div>
                    </td>
                    <td>
                        <div>
                            ...
                            <input type="text" id="experienciaNome[{{ $index }}]"
                                ...
                                wire:model.prevent="experiencia.{{ $index }}.experienciaNome" required="">
                        </div>
                    </td>
                    <td>
                        <div>
                            ...
                            <input type="text" id="experienciaCargo[{{ $index }}]"
                                ...
                                wire:model.prevent="experiencia.{{ $index }}.experienciaCargo" required="">
                        </div>
                    </td>
                    <td>
                        <div>
                            ...
                            <input type="text" id="experienciaInicioContrato[{{ $index }}]"
                                name="experienciaInicioContrato[{{ $index }}]"
                                class="form-control w-full rounded"
                    ...
                    <td>
                        <div>
                            ...
                            <input type="text" id="experienciaFimContrato[{{ $index }}]"
                                name="experienciaFimContrato[{{ $index }}]"
                                class="form-control w-full rounded"
                    ...
                    <td>
                        <div>
                            ...
                            <textarea type="text" id="experienciaDescricao[{{ $index }}]"
                                name="experienciaDescricao[{{ $index }}]" class="form-control w-full rounded" required=""
                                wire:model.prevent="experiencia.{{ $index }}.experienciaDescricao"></textarea>
                        </div>
                    </td>
                    <td>
                        <div class="text-end">
                            <button class="bg-red-500 w-44 h-8 rounded mt-4 text-white font-bold hover:bg-green-600"
                                wire:click.prevent="removeExperiencia({{ $index }})">Remover Experiência
                                {{ $index + 1 }}</button>
                        </div>
                    </td>
                </tr>
        ...
        <div class="text-center mt-6">
            <button class="bg-blue-500 w-full h-12 rounded text-white font-bold" type="button"
                @click="habilidades = !habilidades">Habilidades</button>
        </div>
        <div :class="{ 'hidden': !habilidades }">
            @foreach ($habilidades as $index => $form)
                <tr>
                    <td>
                        <div>
                            <input type="hidden" id="habilidadesId[{{ $index }}]"
                                name="habilidadesId[{{ $index }}]"
                                wire:model.prevent="habilidades.{{ $index }}.habilidadesId">
                        </div>
                    </td>
                    <td>
                        <div>
                            <label for="habilidadesDescricao">Descreva a Habilidade {{ $index + 1 }}:</label>
                            <textarea type="text" id="habilidadesDescricao[{{ $index }}]"
                                name="habilidadesDescricao[{{ $index }}]" class="form-control w-full rounded" required=""
                                wire:model.prevent="habilidades.{{ $index }}.habilidadesDescricao"></textarea>
                        </div>
                    </td>
                    <td>
                        <div class="text-end">
                            <button class="bg-red-500 w-44 h-8 rounded mt-4 text-white font-bold hover:bg-green-600"
                                wire:click.prevent="removeHabilidades({{ $index }})">Remover Habilidade
                                {{ $index + 1 }}</button>
                        </div>
                    </td>
                </tr>
